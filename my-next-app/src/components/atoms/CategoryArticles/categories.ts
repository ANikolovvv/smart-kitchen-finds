...
export const categories: Category[] = [
    {
        label: 'Speakers',
        url: '/speakers',
        imageUrl: '/images/echo_speaker_2024.jpg', 
    ...
    },
    {
        label: 'Lighting',
        url: '/lighting',
        imageUrl: '/images/philips_hue_2024.jpg', // Replace with actual image path
    ...
    },
    {
        label: 'Thermostats',
        url: '/thermostats',
        imageUrl: '/images/nest_thermostat_2024.jpg', // Replace with actual image path
    ...
    },
    {
        label: 'Cameras',
        url: '/cameras',
        imageUrl: '/images/ring_camera_2024.jpg', // Replace with actual image path
    ...
    },
    {
        ...
        url: '/locks-security',
        imageUrl: '/images/august_smart_lock_2024.jpg', // Replace with actual image path
